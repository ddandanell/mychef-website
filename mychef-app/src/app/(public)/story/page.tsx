...
export default function StoryPage() {
  return (
    <div>
        ...
        <FadeIn>
          <div className="mx-auto max-w-xl">
            ...
            <div className="mt-6">
              ...
              <blockquote className="mt-6 border-l-2 border-[#C9A96E] pl-4 font-display text-lg italic leading-snug text-[#C9A96E]">
      ...
      <GoldDivider className="mx-auto max-w-xl px-4" />
...
function TimelineItem({ title, desc }: { title: string; desc: string }) {
  return (
    <div className="relative">
      <span className="absolute -left-[25px] top-0.5 block h-2 w-2 bg-[#C9A96E]" />
